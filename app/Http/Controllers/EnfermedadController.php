...
class EnfermedadController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'descripcion'=>'nulleable|string',
        ]);

        Enfermedad::create($request->all());
        return redirect()->route('enfermedades.index')->with('success, Enfermedades created sucesfully');
    }
    ...
    {
        $enfermedad->delete();
        return redirect()->route('enfermedades.index')->with('success, Enfermedad deleted sucesfully');
    }
}